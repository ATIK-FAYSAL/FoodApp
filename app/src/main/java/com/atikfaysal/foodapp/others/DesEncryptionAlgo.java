...
public class DesEncryptionAlgo
{
    ...
    private AdditionalMethods dialogClass;
    ...
    public DesEncryptionAlgo(Context context)
    {
        ...
        dialogClass = new AdditionalMethods(context);
    }
    ...
    private String initialPermutation(String text)
    {
        ...
        {
            dialogClass.errorMessage(e.toString());//if any error then show here
        }
